...
./../../node_modules/grpc-tools/bin/protoc --js_out=import_style=commonjs,binary:./ticketmatcherrpc --grpc_out=./ticketmatcherrpc --plugin=protoc-gen-grpc=./../../node_modules/grpc-tools/bin/grpc_node_plugin ./api-ticket-matcher.proto
